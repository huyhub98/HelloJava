...
public class CarManager {
    ...
    public static Car car = new Honda();
    public static Car car1 = new Vinfast();
    public static Car car2 = new Mercedez();
    public static Car car3 = new Toyota();
    public static Car car4 = new Audi();
    ...
    public static void carTable() {
        String col[] = {"ID", "Car Name", "Brand", "Model", "Price"};
        ...
        for (int i = 0; i < cars.size(); i++) {
            int id = cars.get(i).getId();
            String name = cars.get(i).getName();
            CarBrand brand = cars.get(i).getBrand();
            String model = cars.get(i).getModel();
            Long price = cars.get(i).getPrice();
            Object[] data = {id, name, brand, model, price};
            tableModel.addColumn(data, col);
        }
    }
    // menu chính
    ...
    public static void menu() {
        while (true) {
            ...
            System.out.println("6. lưu report");
            System.out.println("7. xuất report");
    ...
    public static String topFive() {
        ...
        for (int i = 0; i < 5; i++) {
            res += ((Car) cars.get(i)).getName() + " Price: " + ((Car) cars.get(i)).getPrice() + " dollar";
            res += "\n";
        }
        return res;
